...
const trees: Tree[] = [
  {
    ...
    stand: metalStand,
    image: "/catalog-live/afrodita/01_main.jpg",
    ...
    gallery: [
      {
        ...
        description: "Основное фото модели Афродита Премиум на едином студийном фоне каталога.",
        source: "/catalog-live/afrodita/01_main.jpg",
        status: "published",
        src: "/catalog-live/afrodita/01_main.jpg",
        alt: "Ёлка Афродита Премиум, главная фотография",
      ...
      },
      {
        ...
        role: "02_angle",
        title: "Объём кроны",
        description: "Кадр для оценки раскрытия ветвей и общего объёма модели.",
        source: "/catalog-live/afrodita/02_volume.jpg",
        status: "published",
        src: "/catalog-live/afrodita/02_volume.jpg",
        alt: "Ёлка Афродита Премиум, объём кроны",
        label: "Объём кроны",
        thumbPosition: "50% 55%",
      },
      {
        ...
        role: "03_branch",
        title: "Ветка",
        description: "Крупный план ветвей для оценки формы и плотности хвои.",
        source: "/catalog-live/afrodita/03_branch.jpg",
        status: "published",
        src: "/catalog-live/afrodita/03_branch.jpg",
        alt: "Ветка ёлки Афродита Премиум крупным планом",
        label: "Ветка",
        thumbPosition: "55% 48%",
      },
      {
        ...
        role: "04_needles",
        title: "Хвоя",
        description: "Макро хвои для оценки литых веток, цвета и фактуры.",
        source: "/catalog-live/afrodita/04_needles.jpg",
        status: "published",
        src: "/catalog-live/afrodita/04_needles.jpg",
        alt: "Хвоя ёлки Афродита Премиум крупным планом",
        label: "Хвоя",
        thumbPosition: "50% 48%",
      },
      {
        ...
        description: "Технический кадр шарнирного крепления ветвей.",
        source: "/catalog-live/afrodita/05_construction.jpg",
        status: "published",
        src: "/catalog-live/afrodita/05_construction.jpg",
        alt: "Крепление ветвей ёлки Афродита Премиум",
      ...
      },
      {
        ...
        role: "05_stand",
        title: "Подставка",
        description: "Фото комплектной металлической подставки.",
        source: "/catalog-live/afrodita/06_stand.jpg",
        status: "published",
        src: "/catalog-live/afrodita/06_stand.jpg",
        alt: "Металлическая подставка ёлки Афродита Премиум",
        label: "Подставка",
        thumbPosition: "50% 72%",
      },
    ],
  ...
  },
  {
    ...
    gallery: [
      ...
      },
      {
        ...
        source: "/catalog-live/tayga/04_needles.jpg",
        status: "published",
      ...
      },
      {
        ...
        source: "/catalog-live/tayga/06_construction.jpg",
        status: "published",
      ...
      },
      {
        ...
        source: "/catalog-live/tayga/05_stand.jpg",
        status: "published",
  ...
  },
  {
    ...
    stand: metalStand,
    image: "/catalog-live/krasavitsa/01_main.png",
    cardImage: "/catalog-live/krasavitsa/01_main_card.png",
    imagePosition: "center center",
    cardTone: "studio",
    gallery: [
      {
        ...
        role: "01_main",
        title: "Главная фотография",
        description: "Основное фото модели Красавица светлая на едином студийном фоне каталога.",
        source: "/catalog-live/krasavitsa/01_main.png",
        status: "published",
        src: "/catalog-live/krasavitsa/01_main.png",
        alt: "Ёлка Красавица светлая, главная фотография",
        label: "Главная фотография",
        thumbPosition: "50% 50%",
      },
      {
        ...
        role: "02_angle",
        title: "Объём кроны",
        description: "Кадр для оценки объёма ветвей без повторения общего вида в полный рост.",
        source: "/catalog-live/krasavitsa/02_volume.png",
        status: "published",
        src: "/catalog-live/krasavitsa/02_volume.png",
        alt: "Ёлка Красавица светлая, объём кроны",
        label: "Объём кроны",
        thumbPosition: "55% 48%",
      },
      {
        ...
        role: "03_branch",
        title: "Ветка",
        description: "Крупный план ветки для оценки формы, длины иголок и фактуры модели.",
        source: "/catalog-live/krasavitsa/03_branch.png",
        status: "published",
        src: "/catalog-live/krasavitsa/03_branch.png",
        alt: "Ветка ёлки Красавица светлая крупным планом",
        label: "Ветка",
        thumbPosition: "50% 48%",
      },
      {
        ...
        role: "04_needles",
        title: "Хвоя",
        description: "Макро хвои для оценки литых веток, светлого оттенка и фактуры.",
        source: "/catalog-live/krasavitsa/04_needles.png",
        status: "published",
        src: "/catalog-live/krasavitsa/04_needles.png",
        alt: "Хвоя ёлки Красавица светлая крупным планом",
        label: "Хвоя",
        thumbPosition: "50% 48%",
      },
      {
        ...
        role: "05_stand",
        title: "Подставка",
        description: "Фото комплектной металлической подставки на едином студийном фоне.",
        source: "/catalog-live/krasavitsa/05_stand.png",
        status: "published",
        src: "/catalog-live/krasavitsa/05_stand.png",
        alt: "Металлическая подставка ёлки Красавица светлая",
        label: "Подставка",
        thumbPosition: "50% 46%",
      },
    ],
  ...
  },
  {
    ...
    assembly: "Шарнирная сборка",
    stand: metalStand,
    image: "/catalog-live/lady/01_main.png",
    cardImage: "/catalog-live/lady/01_main_card.png",
    imagePosition: "center center",
    cardTone: "studio",
    gallery: [
      {
        ...
        role: "01_main",
        title: "Главная фотография",
        description: "Реальное фото модели Леди с заменой окружения на единый студийный фон каталога.",
        source: "/catalog-live/lady/01_main.png",
        status: "published",
        src: "/catalog-live/lady/01_main.png",
        alt: "Ёлка Леди, главная фотография",
        label: "Главная фотография",
        thumbPosition: "50% 50%",
      },
    ],
